...
<head>
    ...
    <title>Melati | Login</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl" crossorigin="anonymous">
    <!-- Link icon -->
    <link href='https://unpkg.com/boxicons@2.1.2/css/boxicons.min.css' rel='stylesheet'>
    <!-- Link CSS -->
    <link rel="stylesheet" href="{{ asset('css/style_mahasiswa/style-login.css') }}">
    <!-- Link icon tab browser -->
    <link rel="icon" href="{{ asset('img/logo-tab.png') }} ">
</head>
    ...
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #fff">
        <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row"
            ...
            <div class="position-relative d-none d-lg-block h-100 width-left">
                <img class="position-absolute img-fluid centered" src="{{ asset('img/login.png') }}" alt="" />
            </div>
                    ...
                    <form style="margin-top: 1.5rem" method="POST" action="{{ route('login') }}">
                        ...
                        <div style="margin-bottom: 1.75rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                <svg class="icon" style="margin-right: 1rem" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <input class="input-field border-0 @error('nip') is-invalid @enderror" type="text"  name="nip" value="{{ old('nip') }}" id=""
                        ...
                        <div style="margin-top: 1rem">
                            ...
                            <div class="d-flex w-100 div-input">
                                ...
                                <input class="input-field border-0 @error('password') is-invalid @enderror" type="password"  name="password" id="password-content-3-5"
                                    placeholder="Masukan Password anda" minlength="1" required />
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
