<!-- AWAL FOOTER -->
<section class="footer h-100 w-100 bg-white" style="box-sizing: border-box">
    <div class="footer-2-2 container-fluid mx-auto position-relative p-0" style="font-family: 'Poppins', sans-serif">
          ...
          <div class="col-lg-3 col-md-6 ">
            <div class="">
              <div class="list-space">
                <a href="#">
                  <img src="{{ asset('img/logo-tab-melati.png') }}" alt="" width="40px" /></a>
              </div>
      ...
      <div class="border-color info-footer">
        ...
        <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
          ...
          <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center text-caption">
            <p style="margin: 0">Copyright © 2022 <a href="#" class="text-caption text-decoration-none">MELATI </a>| Dibangun oleh Mochtar Muhammad Faisal</p>
          </nav>
        </div>
      </div>
    </div>
